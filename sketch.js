...
gameState="onsling"}}
async function getBackgroundImg(){var response=await fetch("http://worldtimeapi.org/api/timezone/Asia/Kolkata"),responseJSON=await response.json(),datetime=responseJSON.datetime,hour=datetime.slice(11,13);
